// Note: In production, you should call these via a Supabase Edge Function or Backend
// to keep your API Key secret. For now, we use fetch to avoid Node-specific crashes.
const resendKey = import.meta.env.VITE_RESEND_API_KEY;

const callResend = async (payload: any) => {
  if (!resendKey) {
  ...
  try {
    ...
    console.error("Network error calling Resend:", error);
  }
};
